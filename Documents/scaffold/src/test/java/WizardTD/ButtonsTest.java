...
public class ButtonsTest extends App {
    ...
    */
    ...
    public void testBuildTowerKey() {
        ...
        assertEquals('b', build.getKey(), "Incorrect key flag for BuildTower subclass");
    }
    ...
    public void testMouseSelectAndKeyUnselect() {
        ...
        fast_forward.drawButtons(this, mana, wave); //selected

        key = fast_forward.getKey();
        fast_forward.drawButtons(this, mana, wave);
