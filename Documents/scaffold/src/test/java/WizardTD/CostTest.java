...
public class CostTest extends App {
    ...
    public void testTotalCostCalculationOneUpgrade() {
        UpgradeCost cost = new UpgradeCost(u3, u1, u2);
        int range_level = 3;
        int exp_cost = UpgradeCost.getUpgradeCost(range_level);
        
        u1.setSelected();
        cost.tick(this, range_level, 2, 0);
    ...
    public void testTotalCostCalculationTwoUpgrades() {
        ...
        int range_level = 0;
        int damage_level = 5;
        int exp_cost = UpgradeCost.getUpgradeCost(range_level) + UpgradeCost.getUpgradeCost(damage_level);
        
        u1.setSelected();
        u3.setSelected();
        cost.tick(this, range_level, damage_level, 2);
