...
public class FireballTest extends App {
    ...
    public void testConstruction() {
        Fireball fire_test = new Fireball(10, 10, 20, 20, fireball);
    ...
    public void testFastForwardSpeed() {
        ...
        Fireball fire_test = new Fireball(10, 10, 20, 20, fireball);
        int exp_speed = 10; //speed should double

        fire_test.tick(this, ff);
    ...
    public void testFastForwardCounts() {
        ...
        Fireball fire_test = new Fireball(10, 10, 20, 20, fireball);
        double exp_dist = Math.sqrt(10*10 + 10*10);
        int exp_counts = (int)Math.round(exp_dist/10); //exp counts
